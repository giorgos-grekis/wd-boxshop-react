                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-9 skeleton-body skel-shop-products">
                            ...
                            {
                                BlogData.slice( ( curPage - 1 ) * displayCount, curPage * displayCount ).map( ( blog, index ) => (
                                    <BlogTypeOne addClass="" blog={ blog } key={ "BlogTypeOne" + index } />
                                ) )
                            }
                        ...
                        <aside className="sidebar col-lg-2 mobile-sidebar">
