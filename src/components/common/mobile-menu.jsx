                ...
                <div className="mobile-menu-wrapper">
                    ...
                    <nav className="mobile-nav">
                        <ul className="mobile-menu">
                            <li className={ path === process.env.PUBLIC_URL + '/' ? 'active' : '' }><Link to={ `${process.env.PUBLIC_URL}` }>Αρχική</Link></li>

                            <SlideToggle collapsed={ true }>
                                {
                                    ( { onToggle, setCollapsibleElement, toggleState } ) => (
                                        <li className={ path.indexOf( "categories/" ) > -1 ? 'active' : '' }>
                                            <Link to="#" data-toggle="collapse" onClick={ ( e ) => { e.preventDefault(); onToggle(); } } className={ toggleState.toLowerCase() }>ΣΥΣΚΕΥΕΣ
                            ...
                            <SlideToggle collapsed={ true }>
                                {
                                    ( { onToggle, setCollapsibleElement, toggleState } ) => (
                                        <li className={ path.indexOf( "products/" ) > -1 ? 'active' : '' }>
                                            <Link to="#" data-toggle="collapse" onClick={ ( e ) => { e.preventDefault(); onToggle(); } } className={ toggleState.toLowerCase() }>ΑΞΕΣΟΥΑΡ
                                            <span className="mmenu-btn"></span>
                                            </Link>
                                            <ul ref={ setCollapsibleElement }>
                                                <SlideToggle collapsed={ true }>
                                                    {
                                                        ( { onToggle, setCollapsibleElement, toggleState } ) => (
                                                            <li>
                                                                <Link to="#" data-toggle="collapse" onClick={ ( e ) => { e.preventDefault(); onToggle(); } } className={ toggleState.toLowerCase() }>Variations
                                                                <span className="mmenu-btn"></span>
                                                                </Link>
                                                                <ul ref={ setCollapsibleElement }>
                                                ...
                                                <SlideToggle collapsed={ true }>
                                                    {
                                                        ( { onToggle, setCollapsibleElement, toggleState } ) => (
                                                            <li>
                                                                <Link to="#" data-toggle="collapse" onClick={ ( e ) => { e.preventDefault(); onToggle(); } } className={ toggleState.toLowerCase() }>Product Layout Types
                                                                <span className="mmenu-btn"></span>
                                                                </Link>
                                                                <ul ref={ setCollapsibleElement }>
                            ...
                            <SlideToggle collapsed={ true }>
                                {
                                    ( { onToggle, setCollapsibleElement, toggleState } ) => (
                                        <li className={ `sf-with-ul ${path.indexOf( "pages/" ) > -1 ? 'active' : ''}` }>
                                            <Link to="#" data-toggle="collapse" onClick={ ( e ) => { e.preventDefault(); onToggle(); } } className={ toggleState.toLowerCase() }>B STOCK
                                                <span className="mmenu-btn"></span>
                                            </Link>
                                            <ul ref={ setCollapsibleElement }>
                                                ...
                                                <SlideToggle collapsed={ true }>
                                                    {
                                                        ( { onToggle, setCollapsibleElement, toggleState } ) => (
                                                            <li>
                                                                <Link to="#" data-toggle="collapse" onClick={ ( e ) => { e.preventDefault(); onToggle(); } } className={ toggleState.toLowerCase() }>Checkout
                                                                <span className="mmenu-btn"></span>
                                                                </Link>
                                                                <ul ref={ setCollapsibleElement }>
                                                ...
                                                <SlideToggle collapsed={ true }>
                                                    {
                                                        ( { onToggle, setCollapsibleElement, toggleState } ) => (
                                                            <li>
                                                                <Link to="#" data-toggle="collapse" onClick={ ( e ) => { e.preventDefault(); onToggle(); } } className={ toggleState.toLowerCase() }>Dashboard
                                                                <span className="mmenu-btn"></span>
                                                                </Link>
                                                                <ul ref={ setCollapsibleElement }>
                                                ...
                                                <SlideToggle collapsed={ true }>
                                                    {
                                                        ( { onToggle, setCollapsibleElement, toggleState } ) => (
                                                            <li>
                                                                <Link to="#" data-toggle="collapse" onClick={ ( e ) => { e.preventDefault(); onToggle(); } } className={ toggleState.toLowerCase() }>Blog<span className="mmenu-btn"></span></Link>
                                                                <ul ref={ setCollapsibleElement }>
                    ...
                    <div className="social-icons">
                        <Link to="#" className="social-icon" target="_blank" title="Facebook social-icon"><i className="icon-facebook"></i></Link>
                        <Link to="#" className="social-icon" target="_blank" title="Twitter social-icon"><i className="icon-twitter"></i></Link>
                        <Link to="#" className="social-icon" target="_blank" title="Instagram social-icon"><i className="icon-instagram"></i></Link>
                    </div>
                </div>
            </div>
        </>
