...
// import Data
import OverlayPaths from '../mock-data/data.json';

// import Style For React
...
function Layout ( props ) {
    ...
    useLayoutEffect( () => {
        ...
        for ( let i = 0; i < OverlayPaths.innerOverlayPaths.length; i++ ) {
            if ( prevPath.indexOf( OverlayPaths.innerOverlayPaths[ i ] ) > 0 && props.location.pathname.indexOf( OverlayPaths.innerOverlayPaths[ i ] ) > 0 ) {
                overlayFlag = false;
            }
